...
public void CreacionEsbirrosDeDemonio(String nombre, int salud, String pacto){ //Creación de esbirros hijos aleatoriamente para no estar constantemente introduciendo información por pantalla
        int numEsbirrosHijos = (int)(Math.random()*3);
        for (int i=0; i < numEsbirrosHijos; i++) { //Ponemos un tope para que no se creen un número muy grande de esbirros.
    ...
    public Demonio(String nombre, int salud, String pacto) {
        ...
        CreacionEsbirrosDeDemonio( nombre, salud, pacto);//Creación de esbirros hijos aleatoriamente para no estar constantemente introduciendo información por pantalla
    }

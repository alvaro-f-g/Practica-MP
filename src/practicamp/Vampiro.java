...
public class Vampiro extends Personaje implements Serializable {
    ...
    public Vampiro(String nombre, ArrayList<Arma> listaArmas, ArrayList<Arma> armasActivas, ArrayList<Armadura> listaArmaduras, ArrayList<Esbirro> listaEsbirros, int cantidadOro,int puntos,  int puntosSangre, int edad) {
